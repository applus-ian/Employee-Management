...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'emergency_contact1_name' => ['required', 'string', 'max:100'],
            'emergency_contact1_relationship' => ['required', 'string', 'max:100'],
            'emergency_contact1_phone_number' => ['required', 'string', 'max:20'],
            'emergency_contact2_name' => ['nullable', 'string', 'max:100'],
            'emergency_contact2_relationship' => ['nullable', 'string', 'max:100'],
            'emergency_contact2_phone_number' => ['nullable', 'string', 'max:20'],
