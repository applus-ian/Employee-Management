...
class LocationAssignmentService
{
    ...
    {
        $decoded_id = $this->employeeService->decodeEmployeeId($data['employee_id']);
    ...
    {
         $data['employee_id'] = $this->employeeService->decodeEmployeeId($data['employee_id']);
