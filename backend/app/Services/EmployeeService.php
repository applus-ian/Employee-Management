...
class EmployeeService
{
    ...
    public function createEmployee(array $data)
    {
        return Employee::create([
            ...
            'emergency_contact1_phone_number' => $data['emergency_contact1_phone_number'],
            'emergency_contact2_name' => $data['emergency_contact2_name'],
            'emergency_contact2_relationship' => $data['emergency_contact2_relationship'],
            'emergency_contact2_phone_number' => $data['emergency_contact2_phone_number'],
            'email' => $data['email'],
