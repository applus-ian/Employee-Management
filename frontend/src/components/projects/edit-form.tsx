    ...
    <div className="p-4 mb-6 space-y-6">
      ...
      <div className="flex justify-end space-x-3 pt-8 border-t border-gray-200">
        <Button
          type="button"
          onClick={onCancel}
          className="bg-white text-gray-700 border border-gray-300 hover:bg-gray-100 px-6 py-2 rounded-xl text-sm font-medium"
        >
          Cancel
        </Button>
        <Button
          ...
          disabled={isPending}
          className="bg-orange-500 text-white hover:bg-orange-600 px-6 py-2 rounded-xl text-sm font-medium"
        >
