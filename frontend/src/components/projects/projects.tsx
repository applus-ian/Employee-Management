        ...
        <div className="flex gap-2">
          <Dialog>
            <DialogTrigger asChild>
              <button className="px-2 py-2 text-[#EE7A2A] font-medium text-xs rounded-md hover:bg-[#FFA161] hover:text-white border border-[#EE7A2A] flex items-center gap-1">
                Add New Project
                <CirclePlus size={18} strokeWidth={2} />
              </button>
            </DialogTrigger>
            <DialogContent className="w-full lg:!max-w-[45rem] h-full flex flex-col bg-white overflow-y-scroll">
              <div>
        ...
        <div className="order-2 pr-10 w-full">
          <div className="relative bg-white rounded-md">
            ...
            <Input
              ...
              className="hover:border-orange-300 pl-10 text-gray-500"
            />
          </div>
        </div>
      </div>
