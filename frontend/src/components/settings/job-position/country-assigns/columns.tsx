...
import { EditCountryAssignForm } from './edit-form';
...
export const columns: ColumnDef<CountryAssign>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const { mutate: updateCountryAssign } = useUpdateCountryAssign();
      const { mutate: deleteCountryAssign, isPending: isDeleting } = useDeleteCountryAssign();
        ...
        <div className="flex gap-2">
          ...
          <Dialog open={editOpen} onOpenChange={setEditOpen}>
            ...
            <DialogContent className="bg-white w-[50%]">
              <DialogHeader>
                <DialogTitle>Edit Country Assign</DialogTitle>
              </DialogHeader>
              <EditCountryAssignForm
                country_assign={item} // Pass the country data to the edit form
          ...
          <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
            ...
            <DialogContent className="bg-white">
              ...
              <div className="px-5 pt-5 flex justify-center gap-x-6">
                <Button
                  onClick={handleDelete} // Call handleDelete to delete the country assign
