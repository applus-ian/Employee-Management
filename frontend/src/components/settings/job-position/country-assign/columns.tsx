...
export type Country_Assign = {
  country_assignName: string;
};

export const columns: ColumnDef<Country_Assign>[] = [
  {
      ...
      return (
        <div className="flex gap-2">
          ...
          <Dialog>
            ...
            {/* <EditCountryAssignForm onCancel={handleCancel} onSave={handleSave} /> */}
          </Dialog>
          ...
          <Dialog>
            ...
            <DialogContent className="bg-white">
              ...
              <div className="flex justify-center items-center">
                <p className="text-center">Do you want to delete this Assigned Country?</p>
              </div>
              <DialogClose asChild>
