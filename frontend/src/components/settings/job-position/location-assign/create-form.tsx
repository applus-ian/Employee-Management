...
export default function NewLocationAssignForm({ onCancel, onSave }: NewLocationAssignFormProps) {
  ...
  return (
    <DialogContent className="w-full lg:!max-w-[45rem] h-fit max-h-[35rem] flex flex-col bg-white rounded-m">
      <DialogHeader>
        <DialogTitle>Create New Location Assignment</DialogTitle>
      </DialogHeader>
      <div>
        <form>
          <div className="grid lg:grid-cols-2 grid-cols-1 py-4 p-3 max-h-80 gap-4 overflow-y-auto ">
            <div className="flex flex-col py-2 p-3 lg:col-span-2 w-full">
              <div>
                <Label>
