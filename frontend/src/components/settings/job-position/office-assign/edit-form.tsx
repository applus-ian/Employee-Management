...
interface EditOfficeAssignFormProps {
  onCancel: () => void;
  onSave: (roleData: { office_assignName: string }) => void;
}

export default function EditOfficeAssignForm({ onCancel, onSave }: EditOfficeAssignFormProps) {
  ...
  return (
    <DialogContent className="w-full lg:!max-w-[35rem] h-fit flex flex-col">
      <DialogHeader>
        <DialogTitle>Update Office Assignment</DialogTitle>
      </DialogHeader>
      <div>
        <form>
          <div className="grid">
