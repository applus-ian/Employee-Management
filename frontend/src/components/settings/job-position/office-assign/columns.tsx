...
export type Office_Assign = {
  office_assignName: string;
};

export const columns: ColumnDef<Office_Assign>[] = [
  {
      ...
      return (
        <div className="flex gap-2">
          ...
          <Dialog>
            ...
            <EditOfficeAssignForm onCancel={handleCancel} onSave={handleSave} />
          </Dialog>
          ...
          <Dialog>
            ...
            <DialogContent className="bg-white">
              ...
              <div className="flex justify-center items-center">
                <p className="text-center">Do you want to delete this Assigned Office?</p>
              </div>
              <DialogClose asChild>
